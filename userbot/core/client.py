...
class BADASSBOTUserBotClient(TelegramClient):
    def cat_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**BADASSBOT Error report**\n\n"
                        link = "[here](https://t.me/badassbot_support)"
            ...
            if pattern is not None:
                ...
                if edited:
                    bbub.add_event_handler(func, events.MessageEdited(**kwargs))
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                bbub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                bbub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
BADASSBOTUserBotClient.fast_download_file = download_file
BADASSBOTUserBotClient.fast_upload_file = upload_file
BADASSBOTUserBotClient.reload = restart_script
BADASSBOTUserBotClient.get_msg_link = get_message_link
BADASSBOTUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    BADASSBOTUserBotClient.send_message = send_message
    BADASSBOTUserBotClient.send_file = send_file
    BADASSBOTUserBotClient.edit_message = edit_message
